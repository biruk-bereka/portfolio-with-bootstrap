...
> This is a portfolio project built in bootstrap.
...
```sh
  cd my-folder
  git clone https://github.com/biruk-bereka/portfolio-with-bootstrap.git
```
...
- LinkedIn:[@Mohammad Elshaer](https://www.linkedin.com/in/mohammad-elshaer-29846b195/)
